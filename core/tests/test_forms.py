...
class LoginFormTest(BaseEmailUserTest):
    ...
    def test_form_is_valid_without_remember_me_checkbox(self):
        user = EmailUser.objects.create_user(email='test210@example.com', password='zaqmko123123')
        form = EmailAuthenticationForm(data={'username': 'test210@example.com', 'password': 'zaqmko123123'})
